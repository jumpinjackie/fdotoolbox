...
{
    [Verb("find-cs-by-code", HelpText = "Looks up the coordinate system for the given CS code and outputs details about the coordinate system")]
    public class FindCsByCodeCommand : BaseCommand
    {
        [Option("cs-code", Required = true, HelpText = "The CS code")]
        ...
        public override int Execute()
        {
            ...
            {
                var cs = catalog.FindCoordinateSystemByCode(this.Code);
                if (cs == null)
                {
