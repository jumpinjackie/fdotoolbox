...
{
    [Verb("is-valid-wkt", HelpText = "Checks if the given coordinate system WKT is valid")]
    public class IsValidWktCommand : BaseCommand
    {
        ...
        public override int Execute()
        {
            ...
            var result = csFactory.IsValid(wkt);
