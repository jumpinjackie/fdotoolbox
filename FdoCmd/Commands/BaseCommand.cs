...
namespace FdoCmd.Commands
{
    public abstract class BaseCommand
    {
        ...
        protected (IEnumerable<KeyValuePair<string, string>>, int?) ValidateTokenPairSet(string parameterName, IEnumerable<string> tokens)
            => ConnectUtils.ValidateTokenPairSet(parameterName, tokens);
    }
}
